...
(
    ...
    CONSTRAINT `DataPlatformPlannedOrderItemDataProductionUnit_fk` FOREIGN KEY (`ProductionUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`),
