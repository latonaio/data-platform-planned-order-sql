...
(
    ...
    CONSTRAINT `DPFMPlannedOrderHeaderDataDestinationDeliverToPlantStorageLocation_fk` FOREIGN KEY (`DestinationDeliverToParty`, `DestinationDeliverToPlant`, `DestinationDeliverToPlantStorageLocation`) REFERENCES `data_platform_plant_storage_location_data` (`BusinessPartner`, `Plant`, `StorageLocation`),
	CONSTRAINT `DPFMPlannedOrderHeaderDataDepartureDeliverFromPlantStorageLocation_fk` FOREIGN KEY (`DepartureDeliverFromParty`, `DepartureDeliverFromPlant`, `DepartureDeliverFromPlantStorageLocation`) REFERENCES `data_platform_plant_storage_location_data` (`BusinessPartner`, `Plant`, `StorageLocation`),
    ...
    CONSTRAINT `DPFMPlannedOrderHeaderDataPlannedOrderDestinationProductionUnit_fk` FOREIGN KEY (`PlannedOrderDestinationProductionUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`),
    ...
    CONSTRAINT `DPFMPlannedOrderHeaderDataProject_fk` FOREIGN KEY (`Project`) REFERENCES `data_platform_project_project_data` (`Project`),
    CONSTRAINT `DPFMPlannedOrderHeaderDataWBSElement_fk` FOREIGN KEY (`Project`, `WBSElement`) REFERENCES `data_platform_project_wbs_element_data` (`Project`, `WBSElement`),
	CONSTRAINT `DPFMPlannedOrderHeaderDataReservationItem_fk` FOREIGN KEY (`Reservation`, `ReservationItem`) REFERENCES `data_platform_reservation_document_item_data` (`Reservation`, `ReservationItem`)
