...
(
    ...
    CONSTRAINT `DataPlatformPlannedOrderHeaderDataPlannedOrderDestinationDeliveryUnit_fk` FOREIGN KEY (`PlannedOrderDestinationDeliveryUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`),
	CONSTRAINT `DataPlatformPlannedOrderHeaderDataPlannedOrderDepartureDeliveryUnit_fk` FOREIGN KEY (`PlannedOrderDepartureDeliveryUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`),
    CONSTRAINT `DataPlatformPlannedOrderHeaderDataPlannedOrderDestinationProductionUnit_fk` FOREIGN KEY (`PlannedOrderDestinationProductionUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`),
	CONSTRAINT `DataPlatformPlannedOrderHeaderDataPlannedOrderDepartureProductionUnit_fk` FOREIGN KEY (`PlannedOrderDepartureProductionUnit`) REFERENCES `data_platform_quantity_unit_quantity_unit_data` (`QuantityUnit`),
